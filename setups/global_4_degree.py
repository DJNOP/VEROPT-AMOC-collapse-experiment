...
class GlobalFourDegreeSetup(VerosSetup):
    ...
    def set_parameter(self, state):
        ...
        settings.description = "Global 4° with TKE/EKE; Veropt-wired params + SSS hosing"
        ...
        if rp:
            ...
            logger.info(
                ...
                f"c_k={settings.c_k}, "
                f"kappaH_min={settings.kappaH_min}, "
                f"eke_c_k={settings.eke_c_k}, "
                f"eke_c_eps={settings.eke_c_eps}, "
